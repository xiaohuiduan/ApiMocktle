...
| --- | --- | --- | --- | --- |
| **项目管理** | **项目列表**<br/>卡片展示 API/模型/快捷请求/自测数量与角色权限<br/>[![项目列表](assets/readme/thumbs/01-projects.jpg)](assets/readme/01-projects.png) | **新建项目**<br/>项目名称 + 885 个图标选择<br/>[![新建项目](assets/readme/thumbs/02-project-create.jpg)](assets/readme/02-project-create.png) | **编辑项目**<br/>修改名称与图标<br/>[![编辑项目](assets/readme/thumbs/03-project-edit.jpg)](assets/readme/03-project-edit.png) | **快速切换**<br/>多项目标签栏 + 搜索切换<br/>[![项目切换](assets/readme/thumbs/04-project-tabs.jpg)](assets/readme/04-project-tabs.png) |
| **接口文档** | **接口文档**<br/>树形目录 + 参数表格 + 多状态码响应<br/>[![接口文档](assets/readme/thumbs/05-api-doc.jpg)](assets/readme/05-api-doc.png) | **接口编辑**<br/>Query/Path/Header/Cookie 与 6 种 Body 类型<br/>[![接口编辑](assets/readme/thumbs/06-api-edit.jpg)](assets/readme/06-api-edit.png) | **Schema 编辑**<br/>请求体/响应 JSON Schema 树形编辑器<br/>[![Schema 编辑](assets/readme/thumbs/07-api-schema.jpg)](assets/readme/07-api-schema.png) | **数据模型**<br/>`$ref` 跨接口复用模型定义<br/>[![数据模型](assets/readme/thumbs/08-api-model.jpg)](assets/readme/08-api-model.png) |
| **接口运行** | **运行参数**<br/>环境变量解析、参数覆盖、body 切换不丢文本<br/>[![运行参数](assets/readme/thumbs/09-api-run.jpg)](assets/readme/09-api-run.png) | **运行结果**<br/>格式化 JSON 响应 + 耗时<br/>[![运行结果](assets/readme/thumbs/10-api-run-result.jpg)](assets/readme/10-api-run-result.png) | **请求响应头**<br/>实际发出请求头 + 响应头、cURL 一键复制<br/>[![请求响应头](assets/readme/thumbs/11-api-headers.jpg)](assets/readme/11-api-headers.png) | **运行历史**<br/>自动保存最近 10 条，一键回填<br/>[![运行历史](assets/readme/thumbs/12-api-history.jpg)](assets/readme/12-api-history.png) |
| **自动化测试** | **任务列表**<br/>文件夹分组 + 状态/失败即停管理<br/>[![任务列表](assets/readme/thumbs/13-test-tasks.jpg)](assets/readme/13-test-tasks.png) | **流程画布**<br/>9 种节点拖拽编排 + ELK 自动布局<br/>[![流程画布](assets/readme/thumbs/14-flow-canvas.jpg)](assets/readme/14-flow-canvas.png) | **节点配置**<br/>请求覆盖/断言/提取器可视化编辑<br/>[![节点配置](assets/readme/thumbs/15-flow-config.jpg)](assets/readme/15-flow-config.png) | **流程运行**<br/>环境选择 + 单节点调试 + 实时日志<br/>[![流程运行](assets/readme/thumbs/16-flow-run.jpg)](assets/readme/16-flow-run.png) |
| **环境管理** | **环境空间**<br/>全局变量 / 密钥统一维护<br/>[![环境空间](assets/readme/thumbs/17-env-global.jpg)](assets/readme/17-env-global.png) | **全局参数**<br/>Header/Query/Cookie/Body 全局参数<br/>[![全局参数](assets/readme/thumbs/18-env-params.jpg)](assets/readme/18-env-params.png) | **环境编辑**<br/>前置 URL + 环境变量 + 全局参数<br/>[![环境编辑](assets/readme/thumbs/19-env-edit.jpg)](assets/readme/19-env-edit.png) | **环境切换**<br/>顶部工具栏随时切换环境<br/>[![环境切换](assets/readme/thumbs/20-env-switch.jpg)](assets/readme/20-env-switch.png) |
| **文档分享** | **分享面板**<br/>局域网分享服务 + 链接列表<br/>[![分享面板](assets/readme/thumbs/21-share-panel.jpg)](assets/readme/21-share-panel.png) | **新建分享**<br/>标题 / 密码 / 过期时间<br/>[![新建分享](assets/readme/thumbs/22-share-create.jpg)](assets/readme/22-share-create.png) | **选择范围**<br/>分享全部或勾选指定接口<br/>[![选择范围](assets/readme/thumbs/23-share-scope.jpg)](assets/readme/23-share-scope.png) | **编辑分享**<br/>保留/设置/移除访问密码<br/>[![编辑分享](assets/readme/thumbs/24-share-edit.jpg)](assets/readme/24-share-edit.png) |
## 功能特性

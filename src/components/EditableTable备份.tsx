...
interface ColumnType<RecordType> {
  ...
  dataIndex?: string
  width?: number | string
  render?: (text: UnsafeAny, record: RecordType, index: number) => React.ReactNode
}

export interface EditableTableProps<RecordType = UnsafeAny> {
  rowKey?: string
...
export function EditableTable<RecordType = UnsafeAny>(props: EditableTableProps<RecordType>) {
